...
export const CreateOrEditNoteModalContent = ({
  ...
  return (
      ...
      footer={
        <div className="flex w-full justify-end gap-[var(--spacing8)]">
          <Button
            ...
            type="button"
            onClick={closeModal}
            data-testid="createoredit-note-v2-discard"
          >
            {t`Discard`}
          </Button>
          <Button
    ...
    >
      <Form
        testID="createoredit-note-v2-form"
        aria-label={isEdit ? t`Edit note form` : t`New note form`}
      >
        <div className="flex flex-col gap-[var(--spacing16)]">
          <InputField
            ...
            testID="createoredit-note-v2-title"
          />
